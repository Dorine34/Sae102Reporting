...
\begin{enumerate}
    \item Peut-on dire que \textit{Les femmes ont un salaire équivalent à 76\% de celui des hommes} ? %oui
...
\begin{tcolorbox}[lefttitle=2cm, colframe=gray!75!black, colback=white, title=\textbf{EXERCICE 3 : Subtilités statistiques. Causalité et corrélation.}]
Donnez 3 exemples :
\begin{itemize}
    \item de situation avec une corrélation et causalité directe
    \item de situation avec une corrélation et causalité cachée
    \item de situation avec une corrélation sans causalité 
\end{itemize}
\vspace{5cm}
\end{tcolorbox}
...
\begin{enumerate}
    \item les éléments mis en avant, à travers les biais visuels
...
\scalebox{0.8}{
    \begin{tabular}{|c|c|}\hline
       Enseignement &  pourcentage\\\hline
